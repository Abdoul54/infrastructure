...
return [
    ...
    'auth' => [
        ...
        // Options: AuthIn::BEARER, AuthIn::QUERY, AuthIn::BODY, AuthIn::HEADER
        'in' => AuthIn::BEARER->value,

        // The name of the auth parameter (e.g. token, key, apiKey) or header (e.g. Authorization, Api-Key).
        // For Bearer tokens, this is typically 'Authorization'
        'name' => 'Authorization',
        ...
        'extra_info' => 'Use your Sanctum token in the Authorization header.',
    ],
